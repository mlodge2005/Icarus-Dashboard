...
export default defineSchema({
  ...
  protocols: defineTable({ name: v.string(), trigger: v.union(v.literal("manual"), v.literal("schedule"), v.literal("event")), objective: v.string(), definitionOfDone: v.optional(v.string()), requiredInputs: v.array(v.string()), steps: v.array(v.string()), approvalsRequired: v.boolean(), allowNoInput: v.optional(v.boolean()), scheduleEnabled: v.optional(v.boolean()), scheduleMode: v.optional(v.union(v.literal("interval"), v.literal("weekly"))), scheduleIntervalMinutes: v.optional(v.number()), scheduleWeekday: v.optional(v.union(v.literal("sun"), v.literal("mon"), v.literal("tue"), v.literal("wed"), v.literal("thu"), v.literal("fri"), v.literal("sat"))), scheduleTime: v.optional(v.string()), scheduleTimezone: v.optional(v.string()), lastScheduledRunAt: v.optional(v.string()), lastScheduledSlot: v.optional(v.string()), templateCategory: v.optional(v.string()), active: v.boolean(), createdAt: v.string(), updatedAt: v.string() }).index("by_name", ["name"]).index("by_template_category", ["templateCategory"]),
